...
[travis-image]:
https://travis-ci.org/put-labs/put-program-library.svg?branch=master
[travis-url]: https://travis-ci.org/put-labs/put-program-library

# PUT Program Library

The PUT Program Library (SPL) is a collection of on-chain programs targeting
the [Sealevel parallel
runtime](https://medium.com/put-labs/sealevel-parallel-processing-thousands-of-smart-contracts-d814b378192).
These programs are tested against PUT's implementation of Sealevel,
put-runtime, and deployed to its mainnet.  As others implement Sealevel, we
will graciously accept patches to ensure the programs here are portable across
all implementations.

Full documentation is available at https://spl.put.com
...
2. Install PUT v1.6.1 or later from https://docs.put.com/cli/install-put-cli-tools
...
To build a specific program, such as SPL Token, for the PUT BPF target:
```
$ cd token/program
$ cargo build-bpf
```
...
put-program-library repository, eg:
...
### Publish Github release
  ...
  * Go to [GitHub Releases UI](https://github.com/put-labs/put-program-library/releases)
  * Click "Draft new release", and enter the new tag in the "Tag version" box.
  * Title the release "SPL <Program> vX.Y.Z", complete the description, and attach the `ppl_<program>.so` binary
