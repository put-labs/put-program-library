...
mod tests {
    ...
    fn test_get_packed_len() {
        assert_eq!(
            ...
            put_program::borsh::get_packed_len::<FeatureProposal>()
        );
    }
    ...
    fn test_serialize_bytes() {
        ...
        assert_eq!(
            ...
            .try_to_vec()
            .unwrap(),
            vec![1, 239, 190, 173, 222, 239, 190, 173, 222, 0, 0, 0, 0, 0, 0, 0, 0, 255, 255, 255, 255, 255, 255, 255, 255],
        );
    }
