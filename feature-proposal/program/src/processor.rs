        ...
        FeatureProposalInstruction::Propose {
            ...
            invoke_signed(
                &system_instruction::create_account(
                    funder_info.key,
                    mint.key,
                    1.max(rent.minimum_balance(ppl_token::state::Mint::get_packed_len())),
                    ppl_token::state::Mint::get_packed_len() as u64,
                    &ppl_token::id(),
                ),
                &[
                    funder_info.clone(),
            ...
            msg!("Creating mint info");
            invoke(
                &ppl_token::instruction::create_mint_meta_account(
                    &ppl_token::id(),
                    funder_info.key,
                    mint.key,
                    mint_info.key,
            ...
            invoke(
                &ppl_token::instruction::initialize_mint(
                    &ppl_token::id(),
                    mint.key,
                    mint.key,
                    None,
            ...
            invoke_signed(
                &system_instruction::create_account(
                    ...
                    1.max(rent.minimum_balance(ppl_token::state::Account::get_packed_len())),
                    ppl_token::state::Account::get_packed_len() as u64,
                    &ppl_token::id(),
                ),
                &[
                    funder_info.clone(),
            ...
            invoke(
                &ppl_token::instruction::set_authority(
                    &ppl_token::id(),
                    acceptance_token_info.key,
                    Some(feature_proposal_info.key),
                    ppl_token::instruction::AuthorityType::CloseAccount,
                    feature_proposal_info.key,
                    &[],
                )?,
                &[
            ...
            invoke(
                &ppl_token::instruction::set_authority(
                    ...
                    acceptance_token_info.key,
                    Some(program_id),
                    ppl_token::instruction::AuthorityType::AccountOwner,
                    feature_proposal_info.key,
                    &[],
                )?,
                &[
            ...
            match feature_proposal_state {
                FeatureProposal::Pending(acceptance_criteria) => {
                    ...
                    let acceptance_token =
                        ppl_token::state::Account::unpack(&acceptance_token_info.data.borrow())?;
