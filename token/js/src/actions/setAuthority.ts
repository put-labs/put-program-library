...
import { AuthorityType } from '../instructions/setAuthority.js';
...
export async function setAuthority(
    ...
    if (authorityType == AuthorityType.UpdateMeta){

        let  [meta,_] = await PublicKey.findProgramAddress(
            [ new TextEncoder().encode("MintMeta"), account.toBuffer()],
            programId
        );
