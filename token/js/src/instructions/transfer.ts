import { struct, u8 } from '@com.put/buffer-layout';
import { u64,u128 } from '@com.put/buffer-layout-utils';
import { AccountMeta, PublicKey, Signer, TransactionInstruction } from '@com.put/web3.js';
...
/** TODO: docs */
export const transferInstructionData = struct<TransferInstructionData>([u8('instruction'), u128('amount')]);
