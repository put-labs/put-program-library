...
import {clusterApiUrl, Cluster} from '@com.put/web3.js';
...
export const url =
  process.env.RPC_URL ||
  (process.env.LIVE ? clusterApiUrl(cluster, false) : 'https://rpc.put.com');

export const urlTls =
  process.env.RPC_URL ||
  (process.env.LIVE ? clusterApiUrl(cluster, true) : 'https://rpc.put.com');

export let walletUrl =
  process.env.WALLET_URL || 'https://rpc.put.com';
