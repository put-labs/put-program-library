...
//         const payer = await newAccountWithLamports(connection, 1000000000n);
...
describe('createAccount', () => {
    ...
    before(async () => {
        ...
        it('auxiliary token account', async () => {
            ...
            console.log("auxiliary token account:createAccount");
            const account_key = Keypair.generate();
            console.log("key:",account_key.publicKey.toString());
            ...
            console.log("auxiliary token account:getAccount");
            ...
            console.log("auxiliary token account:createAccount2");
