import type { Signer } from '@com.put/web3.js';
import { PublicKey, Keypair, Connection } from '@com.put/web3.js';
import { TOKEN_PROGRAM_ID } from '../src';

export async function newAccountWithLamports(connection: Connection, lamports = 1000000n): Promise<Signer> {
