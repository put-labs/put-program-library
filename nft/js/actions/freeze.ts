...
import {createFreezeInstruction} from '../src/generated'
...
export async function freeze(
    ...
    log.info("freezing a NFT {}", nftAddress.toBase58())
    const transaction = new Transaction().add(createFreezeInstruction(
